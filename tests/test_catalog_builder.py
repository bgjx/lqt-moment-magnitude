...
def test_data():
    ...
    hypo_dir = Path("tests\sample_tests_data\data\catalog\hypo_catalog.xlsx")
    pick_dir = Path("tests\sample_tests_data\data\catalog\picking_catalog.xlsx")
    sta_dir = Path("tests\sample_tests_data\data\station\station.xlsx")
